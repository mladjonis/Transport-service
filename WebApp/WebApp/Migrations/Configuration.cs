namespace WebApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApp.Persistence.ApplicationDbContext>
    {
        ...
        private void AddOrdinaryUsers(ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any(u => u.UserName == "lukaja.jr@gmail.com"))
            {
                var user = new ApplicationUser() { Id = "lukaja.jr", UserName = "lukaja.jr@gmail", NameEncrypted = "Mladen", SurnameEncrypted = "Lukajic", AdressEncrypted = "Novi Sad", StatusEncrypted = "not verified", EmailEncrypted = "lukaja.jr@gmail.com", PasswordHash = ApplicationUser.HashPassword("password"), DateOfBirth = new DateTime(1996, 9, 6, 10, 02, 01), UserTypeID = 2 };
                userManager.Create(user);
                userManager.AddToRole(user.Id, "AppUser");
            }
            context.SaveChanges();
